    ...
    class ProductInfo extends HTMLElement {
      ...
      updateVariantInputs(variantId) {
        this.querySelectorAll(
          ...
          const originalFormId = productForm.querySelector(
            ".original-form-data-variant-id"
          ); // this is need to change the original id even when we switch to different variant after doing add to cart.
          input.value = variantId ?? "";
          originalFormId.value = variantId ?? "";
      ...
      updateURL(url, variantId) {
        ...
        // to update the image-slider variant-id
        let mediaVariantInput = this.querySelector(".media-variant");
        let rugMaterialVariantInput = this.querySelector(
          ".rug-material-description"
        );
        rugMaterialVariantInput.dataset.variantid = variantId;
        mediaVariantInput.dataset.variantid = variantId;
